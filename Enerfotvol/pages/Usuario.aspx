<%@ Page Title="" Language="C#" MasterPageFile="~/Principal.Master" AutoEventWireup="true" CodeBehind="Usuario.aspx.cs" Inherits="Enerfotvol.Usuario" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
        ...
        <div class="table-responsive">
            <div style="margin-left: 40px">
                <asp:Label ID="lblGestUsuarios" runat="server" Text="Gestión Usuarios"></asp:Label>
                <br />
                <br />
                <asp:Label ID="lblUsuarioB" runat="server" Text="Usuario"></asp:Label>
                <asp:TextBox ID="txtUsuarioB" runat="server" CssClass="text-dark"></asp:TextBox>
                <br />
                <asp:Label ID="lblMailB" runat="server" Text="Mail"></asp:Label>
                <asp:TextBox ID="txtMailB" runat="server" CssClass="text-dark"></asp:TextBox>
                <br />
                <asp:Label ID="lblNombreB" runat="server" Text="Nombre"></asp:Label>
                <asp:TextBox ID="txtNombreB" runat="server" CssClass="form-control"></asp:TextBox>
                <br />
                <asp:Label ID="lblApellidoB" runat="server" Text="Apellido"></asp:Label>
                <asp:TextBox ID="txtApellidoB" runat="server" CssClass="form-control"></asp:TextBox>
                <br />
                ...
                <asp:GridView ID="dgvUsuarios" runat="server" AutoGenerateColumns="False" AllowPaging="True" CellPadding="4" ForeColor="#333333" GridLines="None" OnPageIndexChanging="dgvUsuarios_PageIndexChanging" CssClass="table table-striped table-hover" OnRowCancelingEdit="dgvUsuarios_RowCancelingEdit" OnRowDeleting="dgvUsuarios_RowDeleting" OnRowEditing="dgvUsuarios_RowEditing" OnRowUpdating="dgvUsuarios_RowUpdating" DataKeyNames="Id,Nombre,Apellido,Descripcion,Mail,UltimoLogin,UltimoIntentoF,IntentosF,Bloqueado,Estado" ShowHeaderWhenEmpty="True" ValidationGroup="GridView" >
                    ...
                    <Columns>
                        <asp:BoundField DataField="Id" HeaderText="Usuario" ReadOnly="true" />
                        <asp:BoundField DataField="Nombre" HeaderText="Nombre" />
                        <asp:BoundField DataField="Apellido" HeaderText="Apellido" />
                        <asp:BoundField DataField="Descripcion" HeaderText="Descripción" />
                        <asp:BoundField DataField="Mail" HeaderText="Mail" />
                        <asp:BoundField DataField="UltimoLogin" HeaderText="Ultimo Login" ReadOnly="true" />
                        <asp:BoundField DataField="UltimoIntentoF" HeaderText="Ultimo Intento Fallido" ReadOnly="true" />
                        <asp:BoundField DataField="IntentosF" HeaderText="Intentos Fallidos" ReadOnly="true" />
                        <asp:BoundField DataField="Bloqueado" HeaderText="Bloqueado" ReadOnly="true" />
                        <asp:BoundField DataField="Estado" HeaderText="Activo" ReadOnly="true" />                        
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header">
                       <asp:Label ID="lblAltaUsuario" runat="server" Text="Nuevo Usuario" ></asp:Label>
                    </div>
                    <div class="modal-body">
                        <div class="form-group">
                            <asp:Label ID="lblUsuario" runat="server" Text="Nombre Usuario" ></asp:Label>
                            <asp:TextBox ID="txtUsuario" runat="server" CssClass="text-dark" ></asp:TextBox>
                            <asp:RequiredFieldValidator ID="RequiredFieldValidator2" ControlToValidate="txtUsuario" runat="server" ErrorMessage="*" ValidationGroup="Nuevo"></asp:RequiredFieldValidator>
                            <br />
